...
<cfif not isDefined("ATTRIBUTES.categoryID")><cfset ATTRIBUTES.categoryID = "0" /></cfif>
...
<cfset REQUEST.entry = "#REQUEST.entryService.getEntryByID(ATTRIBUTES.entryID)#" />
<cfset REQUEST.entry.setTitle("#ATTRIBUTES.title#") >
<cfset REQUEST.entry.setBody("#ATTRIBUTES.body#") >
<cfset REQUEST.entry.setCategoryID("#ATTRIBUTES.categoryID#") >
<cfset REQUEST.entryID = REQUEST.entryService.saveEntry("#REQUEST.entry#") >
<cfset REQUEST.entry = "#REQUEST.entryService.getEntryByID(REQUEST.entryID)#" />
<!--------------------------------------------------------------------
	FB50 plugin: CustomExceptionHandler
