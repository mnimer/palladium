...
<cfthrow type="validation.INVALID_ID" message="Invalid Category" detail="You must specify a valid category to remove.">
</cfif>
<!--- do action="delete" --->
<cftry>
...
<cfset ATTRIBUTES.categoryID = "#ATTRIBUTES.categoryID#" >
<cfset myFusebox.thisFuseaction = "delete">
<cfif not isDefined("ATTRIBUTES.categoryID")><cfset ATTRIBUTES.categoryID = "0" /></cfif>
<cfset REQUEST.categoryService = myFusebox.getApplication().getApplicationData().servicefactory.getBean(beanName="categoryService")/> 
<cfset REQUEST.categoryService.removeCategory(categoryID="#ATTRIBUTES.categoryID#") >
