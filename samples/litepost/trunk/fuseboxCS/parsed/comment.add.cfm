...
<cfif not isDefined("ATTRIBUTES.entryID")><cfset ATTRIBUTES.entryID = "0" /></cfif>
<cfif not isDefined("ATTRIBUTES.comment")><cfset ATTRIBUTES.comment = "" /></cfif>
<cfif not isDefined("ATTRIBUTES.name")><cfset ATTRIBUTES.name = "" /></cfif>
...
<cfset REQUEST.comment = "#REQUEST.commentService.getNewComment()#" />
<cfset REQUEST.comment.setEntryID("#ATTRIBUTES.entryID#") >
<cfset REQUEST.comment.setComment("#ATTRIBUTES.comment#") >
<cfset REQUEST.comment.setName("#ATTRIBUTES.name#") >
<cfset REQUEST.comment.setEmail("#ATTRIBUTES.email#") >
<cfset REQUEST.comment.setUrl("#ATTRIBUTES.url#") >
<cfset REQUEST.commentID = "#REQUEST.commentService.saveComment(REQUEST.comment)#" />
<cfset REQUEST.comment = "#REQUEST.commentService.getCommentByID(REQUEST.commentID)#" />
<!--------------------------------------------------------------------
	FB50 plugin: CustomExceptionHandler
