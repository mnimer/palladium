...
<div id="wrapper">
    ...
    <div id="content">
        ...
        <cfset entry = request.entries[i]>
            <h1 style="text-align:left;align:left;"><a href="#request.appPath#/web/litepost-inf/views/main.cfm#entry.getEntryID()#/view.cfm">#entry.getTitle()#</a></h1>
            ...
            <div class="postfooter">
                <span>
                    <a href="#request.appPath#/web/litepost-inf/views/main.cfm#entry.getEntryID()#/view.cfm">
