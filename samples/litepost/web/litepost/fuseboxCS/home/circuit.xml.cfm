...
<circuit access="internal" xmlns:cs="coldspring/">
	...
	<fuseaction name="initColdSpring">
		<cs:initialize coldspringfactory="servicefactory">
			<cs:bean beanDefinitionFile="#expandPath('/config/litepost-services.xml')#" />
		</cs:initialize>
	</fuseaction>
	
	<fuseaction name="getSecurity">
		<cs:get bean="securityService" returnvariable="REQUEST.security" />
	</fuseaction>
