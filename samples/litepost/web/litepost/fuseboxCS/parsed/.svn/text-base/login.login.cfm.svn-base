...
<cfset REQUEST.userService = myFusebox.getApplication().getApplicationData().servicefactory.getBean(beanName="userService")/> 
<cfset REQUEST.user = "#REQUEST.userService.authenticate(ATTRIBUTES.username, ATTRIBUTES.password)#" />
<cfif REQUEST.user.isNull()>
