...
<cfset myFusebox.trace("Runtime","&lt;include template=""qry_getCategories.cfm"" circuit=""category""/&gt;") >
<cftry>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_getCategories.cfm in circuit category which does not exist (from fuseaction category.getAll).">
