...
<cfthrow type="validation.INVALID_ID" message="Invalid bookmark" detail="You must specify a valid bookmark to remove.">
</cfif>
<!--- do action="delete" --->
<cftry>
...
<cfset ATTRIBUTES.bookmarkID = "#ATTRIBUTES.bookmarkID#" >
<cfset myFusebox.thisFuseaction = "delete">
<cfif not isDefined("ATTRIBUTES.bookmarkID")><cfset ATTRIBUTES.bookmarkID = "0" /></cfif>
<cfset REQUEST.bookmarkService = myFusebox.getApplication().getApplicationData().servicefactory.getBean(beanName="bookmarkService")/> 
<cfset REQUEST.bookmarkService.removeBookmark(bookmarkID="#ATTRIBUTES.bookmarkID#") >
