...
<!--- circuit: entry --->
<!--- fuseaction: rssCategory --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "entry">
<cfset myFusebox.thisFuseaction = "rssCategory">
...
<cfset REQUEST.rssService = myFusebox.getApplication().getApplicationData().servicefactory.getBean(beanName="rssService")/> 
<cfset REQUEST.content.rss = REQUEST.rssService.getCategoryRSS(categoryID="#ATTRIBUTES.categoryID#",categoryName="",blogName="#APPLICATION.settings.blog.name#",blogURL="#APPLICATION.settings.blog.url#",blogDescription="#APPLICATION.settings.blog.description#",blogLanguage="#APPLICATION.settings.blog.language#",generator="#APPLICATION.settings.name#",authorEmail="#APPLICATION.settings.blog.email.author#",webmasterEmail="#APPLICATION.settings.blog.email.webmaster#",eventParameter="fuseaction",eventLocation="entry.display") >
<!--------------------------------------------------------------------
	FB50 plugin: CustomExceptionHandler
