...
<div id="wrapper">
    ...
    <div id="content">
        <cfoutput>
            ...
            <a href="#request.appPath#/post/#request.entry.getEntryID()#/edit.cfm" class="adminbutton">Edit</a>
            </cfif>
            ...
            <h2>Add A Comment </h2>
            <form id="comment" name="comment" method="post" action="#request.appPath#/post/#request.entry.getEntryID()#/addComment.cfm">
                <label>Your Name<br/>
