...
$Id: EventArgsInvokerTest.cfc 1892 2009-11-05 05:01:27Z peterfarrell $
...
<cfcomponent
	...
	--->
	<cffunction name="testEventArgsInvokerWithReturn" access="public" returntype="void" output="false"
		hint="Tests the listener method testEventArgsInvokerWithReturn().">
		
		<cfset variables.invoker.invokeListener(variables.event
									, variables.listener
									, "testEventArgsInvokerWithReturn"
									, ""
									, "result") />
	...
	<cffunction name="testEventArgsInvokerWithoutReturn" access="public" returntype="void" output="false"
		...
		<cfset variables.invoker.invokeListener(variables.event
									, variables.listener
									, "testEventArgsInvokerWithoutReturn"
									, ""
									, "") />
